...
const Story = () => {
    ...
    return (
        <section id="story" className="min-h-dvh w-screen text-white bg-black"  >
            <div className="flex size-full flex-col items-center py-10 pb-24">
                <p className="font-general text-sm uppercase md:text-[10px]" >The multiversal IP world</p>
                <div className="relative size-full">
                   
                    <AnimatedStory title="The st<b>o</b>ry of a hidden real<b>m</b>" 
                    sectionId="#story"
                ...
                md:me-44 md:justify-end">
                    <div className="flex h-full w-fit flex-col items-center md:items-start">
                        <p className="mt-3 max-w-sm text-center font-circular-web text-violet-50 md:text-start">
                            Where realms converge, lies Zentry and the boundles pillar. Discover its secrets and shape your fate
