...
const Hero = () => {
    ...
    const totalVideos = 4;
    const nextVideoRef = useRef(null); // when you wanna target the DOM element like div
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75">
        ...
        //muted={isfalse}
        loop
        className="absolute top-0 left-0 transition-all easy-in size-full object-cover object-center"
        onLoadedData={handleVideoLoad}
        />
        <h1 className="special-font hero-heading absolute bottom-5 right-5 z-40 text-blue-75"> G<b>a</b>ming</h1>
      <div className="left-0 top-0 z-40 size-full absolute">
        <div className="mt-24 px-5 sm:px-10">
            <h1 className="special-font hero-heading text-green-500">redefi<b>n</b>e</h1>
