    ...
    return (
        <section className="bg-black pb-52">
            ...
            <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                <BentoTilt className="bnto-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
                    <BentoCard
                ...
                <BentoTilt className="bento-tiltt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
                    <BentoCard 
                    src="videos/feature-3.mp4"
                    title={<>ne<b>x</b>us</>}
                    description="A gamefieldsocial hub, adding a new dimension of play to social interaction for web3 communities."
                    />

                </BentoTilt>
                <BentoTilt className="bento-tiltt_1 me-14 md:col-span-1 md:me-0">
                    <BentoCard 
                ...
                <BentoTilt className="bento-tilt_2">
                    <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
                        <h1 className="bento-title special-font max-w-64 text-black">M<b>ore</b> coming soon!</h1>
